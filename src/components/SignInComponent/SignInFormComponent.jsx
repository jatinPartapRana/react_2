...
const SignInFormComponent = (props) =>{
    return(
        ...
        <SignInInputComponent imgType="fa fa-user fa-2x" inputType="email" placeholder="Email/Username" onInputChange={props.onEmailChange} ></SignInInputComponent>
        <SignInInputComponent imgType="fa fa-lock fa-2x" inputType="password" placeholder="Password" onInputChange={props.onPasswordChange}></SignInInputComponent>
